...
bool PauseMenu::init()
{
	...
	testItem->setPosition(Vec2(musicLabel->getPositionX() + musicLabel->getContentSize().width / 2 + 30, effectControlLabel->getPositionY()));
	...
	helpItem->setPosition(Vec2(origin.x + effectControlLabel->getContentSize().width / 2 + visibleSize.width / 4,
		origin.y + visibleSize.height - helpItem->getContentSize().height * 10));
	...
	backItem->setPosition(Vec2(origin.x + backItem->getContentSize().width * 2.5,
	...
	exitItem->setPosition(Vec2(origin.x + visibleSize.width - backItem->getContentSize().width * 2.5, helpItem->getPositionY() - exitItem->getContentSize().height * 2));
